  ...
  return (
    <div className="program-form-container">
      <Tile className="program-form-tile">
        <h2 className="form-title">Create Body Building Program</h2>
        <p className="form-description">
          Build a personalized body building program focused on muscle hypertrophy, symmetry, and aesthetics.
        </p>
          ...
          <Grid>
            ...
            <Column lg={16} md={8} sm={4}>
              <TextArea
                id="goals"
                labelText="Goals"
                placeholder="Describe your body building goals (e.g., 'Increase arm size', 'Improve chest definition', 'Prepare for competition')"
                rows={4}
